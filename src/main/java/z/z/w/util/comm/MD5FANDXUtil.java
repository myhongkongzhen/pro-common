...
/**************************************************************************
 * <pre>
 *     FileName: com.zy.comm.util.MD5FANDXUtil.java
 *         Desc: 
 *      @author: Z_Z.W - myhongkongzhen@gmail.com
 *     @version: 2015年8月18日 上午10:48:42 
 *   LastChange: 2015年8月18日 上午10:48:42 
 *      History:
 * </pre>
 **************************************************************************/
public class MD5FANDXUtil
{
	
	/*
	 * A Java implementation of the RSA Data Security, Inc. MD5 Message
	 * Digest
	 * Algorithm, as defined in RFC 1321. Based on the JavaScript
	 * implementation
	 * of Paul Johnston Copyright (C) Paul Johnston 1999 - 2000. See
	 * http://pajhome.org.uk/site/legal.html for details. Java Version
	 * by Thomas
	...
	{
//		MD5FANDXUtil md5 = new MD5FANDXUtil();
		String str = MD5FANDXUtil.calcMD5( "VNET$05592542354$5$2013-12-27 20:07:12$455708507$VNET@123" );
