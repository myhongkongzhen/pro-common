...
/**************************************************************************
 * <pre>
 *     FileName: z.z.w.util.http.HttpClient.java
 *         Desc: 
 *      @author: Z_Z.W - myhongkongzhen@gmail.com
 *     @version: 2015年9月17日 上午9:24:10 
 *   LastChange: 2015年9月17日 上午9:24:10 
 *      History:
 * </pre>
 **************************************************************************/
public enum HttpClientBak
{
	INSTANCE ;
...
//				return EntityUtils.toString( entity, "GBK" ) ;
	 ...
	 * @throws Exception
	 */
	public String httpPost( String url , String msg ) throws Exception
	{
		try
		{
	 ...
	 */
	public String httpPostParticular( String httpUrl ) throws Exception
	{
		try
		{
	 ...
	 */
	public String httpPostParticular( String httpUrl , Map< String, String > paramMap , Map< String, String > headerMap ) throws Exception
	{
		try
		{
			URL url = new URL( httpUrl ) ;
